...
**Poznámka k AirTags (2. generace):** Tato zařízení jsou pouhým pozorováním nerozeznatelná od ostatních zařízení Apple Find My. Aby je AirGuard identifikoval jako AirTags, musí se k zařízení připojit.
